...
describe('profile backup locale coverage', () => {
    ...
    it('does not fall back to English for the primary user actions', () => {
        const primaryKeys = [
            ...
            'profile_backup.restore_progress_copy',
            'profile_backup.restore_progress_extract',
            'profile_backup.restore_progress_database_check',
            'profile_backup.restore_progress_verify_staging',
            'profile_backup.preparing_restore',
            'profile_backup.restore_prepare_description',
