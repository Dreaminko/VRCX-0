...
pub fn builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new()
        ...
        .commands(collect_commands![
            ...
            commands::application::notification_chains::app__notification_instance_invite_send,
            ...
            commands::application::registry_backup::app__registry_backup_export_to_file,
            commands::application::registry_backup::app__registry_backup_import_from_file,
            ...
            commands::application::user_dialog_tab_counts::app__user_dialog_tab_counts_get,
            ...
            commands::application::social_mutation::app__social_friend_request_notification_accept,
