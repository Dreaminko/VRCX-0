...
use vrcx_0_application_game::GameLogProjection;
...
pub fn builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new()
        ...
        .commands(collect_commands![
            ...
            commands::application::lifecycle::app__game_client_debug_logging_status,
            commands::application::lifecycle::app__authenticated_session_maintenance_run,
            commands::application::lifecycle::app__authenticated_runtime_phase_snapshot_get,
            ...
            commands::application::llm_endpoint::app__llm_translate,
            ...
            commands::host::updater::app__app_update_status_get,
