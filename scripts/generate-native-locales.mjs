...
const overlayPathKeys = [
    ...
    ['overlay.friends_panel.open', ['overlay', 'friends_panel', 'open']],
    ['overlay.friends_panel.request', ['overlay', 'friends_panel', 'request']],
    ['overlay.friends_panel.invite', ['overlay', 'friends_panel', 'invite']],
    [
