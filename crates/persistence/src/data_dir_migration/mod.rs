...
pub use filesystem::{
    ...
    copy_frozen_database_to_staging, data_dir_available_space, data_dir_migration_required_bytes,
    finalize_data_dir_migration, install_staged_data_dir_database,
};
pub use journal::{
    has_pending_data_dir_migration, migration_journal_path, read_data_dir_cleanup_pending,
    read_pending_data_dir_migration, remove_data_dir_cleanup_pending,
    remove_pending_data_dir_migration, take_data_dir_migration_result,
    write_data_dir_cleanup_pending, write_data_dir_migration_result,
...
pub fn record_data_dir_migration_database_open_failure(
    ...
    remove_data_dir_cleanup_pending(control_dir)?;
    remove_pending_data_dir_migration(control_dir)?;
    write_data_dir_migration_result(
        control_dir,
        &DataDirMigrationResult {
