...
For localization work, download a DevKit build from the [package-devkit workflow](https://github.com/Map1en/VRCX-0/actions/workflows/package-devkit.yml) and use it to load local translations for review.
